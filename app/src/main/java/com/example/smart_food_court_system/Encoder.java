...
//    private static final String ENCODING = "UTF-8";
    ...
    public static String decode64(String s) {
        try {
            byte[] valueDecoded = Base64.decode(s, Base64.DEFAULT);
...
//        BASE64Encoder encoder = new BASE64Encoder();
        ...
        byte[] publicKeyBytes = android.util.Base64.decode(publicKey, Base64.DEFAULT);
//        byte[] publicKeyBytes = decoder.decodeBuffer(publicKey);
        ...
        return android.util.Base64.encodeToString(cipher.doFinal(dataBytes), Base64.DEFAULT)
                .replaceAll("[\\n]","");
//        return new String(encoder.encode(cipher.doFinal(dataBytes)).replace("\r", ""));
    ...
    public static String decryptRSA(String encryptData, String privateKey) {
        try {
            ...
            Log.e("[DecryptRSA] Error: ", ex.toString());
            return "";
        }
    }
