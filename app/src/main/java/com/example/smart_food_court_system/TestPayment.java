...
public class TestPayment extends AppCompatActivity {
    ...
    private String partnerRefId = "Merchant123556666";
    ...
    private void requestPayment() {
        ...
        eventValue.put("orderId", "Merchant123556666"); //uniqueue id cho Bill order, giá trị duy nhất cho mỗi đơn hàng
            ...
            if (data != null) {
                if (data.getIntExtra("status", -1) == 0) {
                    ...
                    if (token != null && !token.equals("")) {
                        ...
                        appData = token;
                        Log.e("appData", token);
                        Log.e("customerNumber", phoneNumber);
